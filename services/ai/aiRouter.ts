import type { Activity, SupportedProvider, RouterResponse, HealthStatus, UsageStats } from '~/types/ai'
...
export class AIRouter {
  ...
  private async generateWithFallback(prompt: string, activities: Activity[]): Promise<RouterResponse> {

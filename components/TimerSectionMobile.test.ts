...
let mockIsRunning = ref(false)
let mockIsPaused = ref(false)
let mockCurrentActivity = ref('')
let mockFormattedTime = ref('00:00:00')
let mockStartTimer = vi.fn()
let mockPauseTimer = vi.fn()
let mockResumeTimer = vi.fn()
let mockFinishTimer = vi.fn()
let mockResetTimer = vi.fn()
...
let mockIsMobile = ref(true)
let mockIsTouchDevice = ref(true)
